...
# GET
if (!isset($_POST['row1'])) {
  $stmt = $pdo->query("SELECT val FROM keyval WHERE keyfield='home_rows_en'");
...
# POST
  ...
  $query = "UPDATE keyval SET val=? WHERE keyfield='home_rows_en'";
...
<head>
  ...
  <title>Редактирование английской версии главной страницы | T.Gallery</title>
</head>
<body>
  ...
  <h2>Редактирование английской версии главной страницы</h2>
  <div class="container">
  ...
  <script src="../../assets/js/adminhomeen.js" defer></script>
</body>
</html>