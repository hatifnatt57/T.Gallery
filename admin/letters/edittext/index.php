...
# POST
  ...
  $query = "UPDATE keyval SET val=? WHERE keyfield='letters_rows'";
...
<head>
  ...
  <title>Редактирование вступительного текста в НамПишут | T.Gallery</title>
</head>
<body>
  ...
  <h2>Редактирование вступительного текста в НамПишут</h2>
  <div class="container">
